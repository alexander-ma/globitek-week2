...
<form action="new.php" method="post">
    First name: <br>
    <input type="text" name="first_name" value="<?php echo h($salesperson['first_name']); ?>" />
    <br>
    Last name:  <br>
    <input type="text" name="last_name" value="<?php echo h($salesperson['last_name']); ?>" />
    <br>
    Phone:      <br>
    <input type="text" name="phone" value="<?php echo h($salesperson['phone']); ?>" />
    <br>
    Email:      <br>
    <input type="text" name="email" value="<?php echo h($salesperson['email']); ?>" />
    <br>
