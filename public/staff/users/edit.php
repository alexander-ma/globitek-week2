...
<div id="main-content">
  <a href="<?php echo u("index.php");?>" >Back to Users List</a><br />

  <h1>Edit User: <?php echo h($old_user['first_name']) . " " . h($old_user['last_name']); ?></h1>

  <?php echo display_errors($errors); ?>

  <form action="<?php echo h("edit.php?id=" . $user['id']); ?>" method="post">
    First name:<br />
